...
void Carrier_Assignment()
{
	...
	do
	{
		...
		if (Background_Array[random_Number_For_Carrier][RANDOM_NUMBER_CARRIER] != 1)
		{
...
void BattleShip_Assignment()
{
	...
	do
	{
		...
		if (Background_Array[random_Number_For_Battleship][RANDOM_NUMBER_BATTLESHIP] != 2)
		{
			if (Background_Array[random_Number_For_Battleship][RANDOM_NUMBER_BATTLESHIP + 1] != 2)
			{
				if (Background_Array[random_Number_For_Battleship][RANDOM_NUMBER_BATTLESHIP + 2] != 2)
				{
					if (Background_Array[random_Number_For_Battleship][RANDOM_NUMBER_BATTLESHIP + 3] != 2)
					{
...
void Frigate_Assignment()
{
	...
	do
	{
		...
		//This will check for overlapping
		if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE] != 2)
		{
			if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE + 1] != 2)
			{
				if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE] != 3)
				{
					if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE + 1] != 3)
					{
						if (random_Number_For_Frigate + 1 < Array_Size)
						{
							break;
						}
					}
...
void Frigate_Assignment2()
{
	...
	do
	{
		...
		if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE] != 1)
		{
			if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE + 1] != 1)
			{
				if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE] != 2)
				{
					if (Background_Array[random_Number_For_Frigate][RANDOM_NUMBER_FRIGATE + 1] != 2)
